  ...
  return (
    <footer className="footer flex justify-between h-auto w-[100vw] text-white bg-[#111111] p-5">
      ...
      <div className="flex flex-col justify-start mt-5 ml-6">
        ...
        <p className="flex items-center mt-[10px] mb-5">
          <svg
          ...
          <span className="ml-[10px]">contact@fryfoundation.com</span>
        </p>
        ...
        <p className="mt-[60px] text-[#595959] text-[12px]">
      ...
      <div className="flex justify-between mt-5">
        ...
        <div className="flex flex-col mx-[10px]">
          <h1 className="mb-5 text-[20px]">Resources</h1>
          <p>
        ...
        <div className="flex flex-col mx-[10px]">
          <h1 className="mb-5 text-[20px]">Legal</h1>
          <p>
